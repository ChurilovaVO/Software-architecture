...
[**deleteSchedule**](ScheduleApi.md#deleteSchedule) | **DELETE** /Schedule/deleteById/{scheduleId} | Удаляет расписание по ID
...
ScheduleApi apiInstance = new ScheduleApi();
Long scheduleId = 789L; // Long | ID расписания
