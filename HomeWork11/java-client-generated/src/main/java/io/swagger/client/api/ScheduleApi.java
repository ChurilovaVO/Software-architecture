...
public class ScheduleApi {
     ...
     * @param body Создать новое расписание в базе (required)
     ...
     * @param scheduleId ID расписания (required)
    ...
    /**
     * Удаляет расписание по ID (asynchronously)
     * Удаляет расписание
     * @param scheduleId ID расписания (required)
     * @param scheduleId  (optional)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @param id Идентификатор расписания (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    /**
     * Найти ркасписание по ID (asynchronously)
     * вернуть одно расписание
     * @param id Идентификатор расписания (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     * @param body Обновить существующее расписание в базе (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
