...
- API version: 0.0.1
  - Build date: 2023-10-22T13:54:02.288257424Z[GMT]
...
*CloudsApi* | [**deleteCloudById**](docs/CloudsApi.md#deleteCloudById) | **DELETE** /clouds/{cloud_id} | Метод удаления заказа на облако по ID
